<template>
	<view class="inputorder2">
		...
		<view class="cont" v-if="showContainer">
			...
			<nor-step-1 @steptap="steptap" @backroute="backroute" :matchInfo="matchInfo" :mid="mid" v-if="current==0"></nor-step-1>
			<nor-step-2 @steptap="steptap" @backroute="backroute" :matchInfo="matchInfo" :mid="mid" v-if="current==1"></nor-step-2>
			<nor-step-3 @steptap="steptap" :matchInfo="matchInfo" v-if="current==2"></nor-step-3>
			</block>
