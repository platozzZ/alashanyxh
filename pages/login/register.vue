			...
			<form @submit="formSubmit">
				<view class="form">
					<view class="cu-form-group">
						<input name="name" type="text" placeholder="请输入用户名" placeholder-class="placeholde"></input>
					</view>
					<view class="cu-form-group">
...
<script>
var that
import { toRegister, captCha } from '@/utils/api.js'
